...
public class ToppedMaterialAttributedItem extends ToppedAttributedItem implements IMaterialAttributed {
    public ToppedMaterialAttributedItem(Properties build, Builder builder) {
        super(build, builder);
    }
