...
import net.mofusya.mechanical_ageing.tiles.tile.BurningChamberTile;
...
public class MAgMachines {
    ...
    public static final MachineObject BRICK_BURNING_CHAMBER = MACHINES.register("brick_burning_chamber", BurningChamberTile::new);
}