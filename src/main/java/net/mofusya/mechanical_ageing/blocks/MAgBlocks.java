...
public class MAgBlocks {
    ...
    public static final RegistryObject<Block> DRIVE_SHAFT = BLOCKS.register("drive_shaft", new OrnateBlockDeferredRegister.Builder()
    ...
    public static final RegistryObject<Block> ROTOR_BLADE = BLOCKS.register("rotor_blade", new OrnateBlockDeferredRegister.Builder()
            .attribute(new AttributedItem.Builder()
                    .attribute("melting_point", 1756, true)
                    .attribute("durability_rp", 1048576, true)
            )
    ...
    public static final RegistryObject<Block> COIL_BLOCK = BLOCKS.register("coil", new OrnateBlockDeferredRegister.Builder()
